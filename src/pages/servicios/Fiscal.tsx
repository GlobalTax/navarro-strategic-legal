  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 bg-primary">
        <div className="container-custom text-primary-foreground animate-fade-in">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-5xl md:text-6xl font-serif">Derecho Fiscal</h1>
          </div>
      ...
      <section className="section-spacing">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-4xl font-serif mb-6">Experiencia fiscal integral</h2>
      ...
      <section className="section-spacing bg-secondary/30">
        <div className="container-custom">
          <h2 className="text-4xl font-serif text-center mb-16">Nuestra metodología</h2>
